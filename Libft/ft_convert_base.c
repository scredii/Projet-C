...
/*   Updated: 2016/11/10 17:20:38 by ddufour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int			ft_r_power(int nb, int power)
{
	int a;
...
static long int	convert_base10(char *nbr, char *base_from, int nbr_caract_b_f)
{
	int			a;
	int			b;
	int			nbr_caract_nbr;
...
static int			*convert_base_to(long int base10, int nbr_caract_b_t)
{
	int			*tab;
	int			nbr_step_div;
	long int	nbr;
...
static char		*cpy(char *base_to, int e, long int base_10, int d)
{
	int		a;
	int		c;
	int		g;
