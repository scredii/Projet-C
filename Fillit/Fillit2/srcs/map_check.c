...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/06/13 11:51:14 by ddufour           #+#    #+#             */
/*   Updated: 2016/06/14 11:36:38 by ddufour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fillit.h"

int		valid_map(char *map, int a, int nbofsharp, int count)
{
	while (map[++a])
	{
		if (map[a] == '#')
...
char	*creat_tetrim(char *map, char *tetris, char letter)
{
	int		a;
...
int		creat_tetris(char *map, t_fillit *fillit)
{
	int		a;
	int		b;
...
int		map_check(char *av, t_fillit *fillit)
{
	...
	if (!(creat_tetris(map, fillit)))
		return (0);
	SIZE = ft_sqrt(fillit->tetris_nbr * 4);
	a = -1;
